...
- **Success Rate**: 100.0%
- **Processing Duration**: 45.62 seconds
...
- **Topic Areas**: health, exercise, sleep, nutrition
...
## Generated Templates
### Template 1: solidao_cronica.md
- **Source**: `work/01_raw/solidao_cronica.md`
- **Output**: `work/02_preprocessed/solidao_cronica/solidao_cronica_filled_template.md`
- **Processing Time**: 45.61 seconds
- **Validation**: ❌ Failed

## Cross-File Analysis
- **Common Themes**: health, exercise, sleep, nutrition
